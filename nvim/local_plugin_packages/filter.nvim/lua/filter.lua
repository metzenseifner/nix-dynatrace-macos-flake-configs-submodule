...
-- lua/filter.lua
---@class Filter
---@field filter_buffer fun(cmd: string, opts?: table): boolean, string
---@field filter_visual fun(cmd: string, opts?: table): boolean, string
---@field map_buffer fun(lhs: string, cmd: string, opts?: table): nil
---@field map_visual fun(lhs: string, cmd: string, opts?: table): nil
---@field set_runner fun(runner: function): nil
local M = {}
