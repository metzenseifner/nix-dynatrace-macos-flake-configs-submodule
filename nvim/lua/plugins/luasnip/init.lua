-- Snippet keymap layout:
--   - <C-f> / <C-b> — jump forward / backward between nodes
--   - <C-l> / <C-h> — cycle choices in the active choiceNode
--   - <C-n> / <C-y> — pure cmp (select-next / confirm), no luasnip logic
return
{
  {
    dir = vim.fn.stdpath('config') .. '/local_plugin_packages/block_factory.nvim',
  },
  {
    "L3MON4D3/LuaSnip",
    event = "VeryLazy",
