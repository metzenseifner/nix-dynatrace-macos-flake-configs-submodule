return {
  {
    ...
    config = function()
      ...
      -- Custom function to generate links for all quickfix items
      vim.keymap.set("n", "<leader>gY", function()
        ...
        if #links > 0 then
          ...
          print("Copied " .. #links .. " quickfix links to clipboard")
        else
          print("No valid links generated from quickfix list")
        end
      end, { desc = "Copy quickfix list as git links", silent = true })
    end,
  },
}
